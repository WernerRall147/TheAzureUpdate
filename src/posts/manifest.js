...
window.BLOG_INDEX = [
  {"id":"azure-update-2026-09-19","url":"posts/azure-update-2026-09-19/index.md","title":"19 September 2026: Manage the code coverage ruleset condition with the REST API, and 54 more","date":"2026-09-19","author":"Werner Rall","tags":["Azure","AI","AKS","App Service","Azure SQL","Cosmos DB","GitHub","PostgreSQL","Quantum"],"featured":true,"excerpt":"55 verified updates across 8 technologies, led by Manage the code coverage ruleset condition with the REST API."},
